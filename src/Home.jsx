...
export default function Home() {
  ...
  useEffect(() => {
    axios
      .get("https://api-to-do-list-livid.vercel.app/get")
  ...
  const handleEdit = (id) => {
    axios
      .put(`https://api-to-do-list-livid.vercel.app/update/${id}`)
      .then(() => {
        setTodos(
          todos.map((todo) =>
  ...
  const handleDelete = (id) => {
    axios
      .delete(`https://api-to-do-list-livid.vercel.app/delete/${id}`)
      .then(() => {
